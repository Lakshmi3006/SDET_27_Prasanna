 ...
 * @param driver
 */
public void WaitForageToLoadForJSElement(WebDriver driver) {
 ...
 */
 ...
 /**
  * used to switch to alert button and click on OK button
  * @param driver
  */
...
/**
 * used to execute the javascript
 * @param driver
 * @param javaScript
 */
